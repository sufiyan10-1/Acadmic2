...
let finalResult;
 ...
 courseData.map((course) =>{
  ...
  const subObtTotalMarks = sub1TotMarks + sub2TotMarks + sub3TotMarks + sub4TotMarks + sub5TotMarks + sub6TotMarks + sub7TotMarks   
    ...
    <header className="flex">
      <div className="flex gap-16">
        <div className="flex flex-col items-center justify-center">
          ...
          {universityData.map(university=>university.universityName)}
          </h2>
          <p className="font-bold">
          {universityData.map(university=>university.address)}
          </p>
          <p>
          {universityData.map(university=>university.webSite)}     
          </p>
      ...
      <div className="font-bold mt-24">
        <p>SR No : {localStorage.getItem('SR_NO')} </p>
      </div>
    </header>
     ...
     {courseData.map(course=>
     <div className='m-12' key={course.cou}>
       ...
       <div className='border-b-2 border-dotted border-gray-900'>
         <p className=''><span className='font-bold'>EXAMINATION : </span><span>  {nameOFExamination.toUpperCase()} {examinationYear} [SEMESTER-{semester} {summerWinter}-{localStorage.getItem('year')} ] </span></p>
         ...
         <table className='flex gap-10'>
            ...
            <td className='font-bold mt-4'>28</td>
             </tr>
             ...
             <td className='font-bold mt-4'>{sub1GradePoint+sub2GradePoint+sub3GradePoint+sub4GradePoint+sub5GradePoint +sub6GradePoint +sub7GradePoint  }</td>
             </tr>
             <tr className='flex flex-col text-center'>
      ...
      <div>
         <p className='mt-4'><span>CGPA :</span><span>{parseFloat((sub1GradePoint+ sub2GradePoint +sub3GradePoint +sub4GradePoint +sub5GradePoint +sub6GradePoint +sub7GradePoint  )/7).toFixed(2)}</span></p>
