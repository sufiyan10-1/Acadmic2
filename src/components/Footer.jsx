...
<footer class="bg-white dark:bg-gray-900">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          ...
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul class="text-gray-500 dark:text-gray-400 font-medium">
                      <li class="mb-4">
                          <Link to="https://flowbite.com/" class="hover:underline">Flowbite</Link>
                      </li>
                      <li>
                          <Link to="https://tailwindcss.com/" class="hover:underline">Tailwind CSS</Link>
                      </li>
                  </ul>
              </div>
              <div>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <Link to="https://flowbite.com/" class="hover:underline">Flowbite™</Link>. All Rights Reserved.
          </span>
